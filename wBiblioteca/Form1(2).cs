    ...
    public partial class frmBiblioteca : Form
    {
        ...
        private void btnIngresar_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                clsDatosPersonales p1 = new clsDatosPersonales(txtNombre.Text, txtApellido.Text, Convert.ToInt32(txtCedula.Text), Convert.ToInt32(txtCelular.Text), Convert.ToDateTime(txtFecha.Text), txtHoraEntrada.Text, txtHoraSalida.Text, txtCargo.Text, txtCorreo.Text);
