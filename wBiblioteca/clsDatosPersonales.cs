...
namespace wBiblioteca
{
    class clsDatosPersonales
    {
        ...
        public clsDatosPersonales(string strNomEmpleado, string strApellEmpleado, int intCedEmpleado, int intNumCelular, string datFecha, string strHoraEntrada, string strHoraSalida, string strCargo, string strCorreo)
        {
        ...
        public bool modificarDato()
        {
            ...
            //LAPTOP-EDL61KRN\TEW_SQLEXPRESS
